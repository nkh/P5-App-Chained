...
$object->check_sub_apps_definitions() ;
...
sub check_sub_apps_definitions
{

=head2 [P]check_sub_apps_definitions()

Verifies the completeness of a sub command definiton.

I<Arguments>

=over 2 

=item * $command_defintion -  A hash reference - 

=back

I<Returns> - Nothing

I<Exceptions> - Dies if the definition is invalid
